package fun.oook.okim.client.handle;
...
import fun.oook.okim.client.service.impl.EchoServiceImpl;
...
import fun.oook.okim.common.protocol.CIMResponseProto;
...
public class CIMClientHandle extends SimpleChannelInboundHandler<CIMResponseProto.CIMResProtocol> {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        //客户端和服务端建立连接时调用
        LOGGER.info("okim server connect success!");
    }
