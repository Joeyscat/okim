...
import fun.oook.okim.client.handle.MsgHandleCaller;
import fun.oook.okim.client.service.impl.MsgCallBackListener;
...
public class BeanConfig {
    ...
    @Value("${okim.callback.thread.queue.size}")
    private int queueSize;

    @Value("${okim.callback.thread.pool.size}")
